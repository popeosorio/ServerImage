...
<a href="uploadImg.php">Subir</a> - <a href="registrar.php">Registrar</a> - <a href="viewImg.php">Ver</a> - <a href="search.php">Buscar</a> - <a href="login.php">Login</a>

<?php 
session_start(); //session_start() crea una sesión para ser usada mediante una petición GET o POST, o pasado por una cookie  
include_once "model.php"; //es la sentencia q usaremos para incluir el archivo de conexión a la base de datos que creamos anteriormente. 
